...
const _renderContactUs = () => (
    <div className='fs-12'>
        ...
        </svg> 250 North Bridge Road, #06-00 Raffles City Tower, Singapore 179 101
        <div className='d-flex'>
            ...
            </svg> Phillip SG Contact (English Speaking): &nbsp;</span>
            <div>
                <span> +65 6212-1810</span>
        ...
        <div>
            ...
            </svg> Phillip SG Email: cddesk@phillip.com.sg
        </div>
    </div>
)
