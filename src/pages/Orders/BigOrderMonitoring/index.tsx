            ...
            <div className="container">
                ...
                <div className="row align-items-stretch g-2 mb-3">
                    <div className="col-lg-9">
                        <ListTickerBigOrder getTicerLastQuote={handleTicker} msgSuccess={msgSuccess} handleSide={getSide} getSymbolCodeRemove={handleSymbolCodeRemove} />
                    </div>
...
export default BigOrderMonitoring