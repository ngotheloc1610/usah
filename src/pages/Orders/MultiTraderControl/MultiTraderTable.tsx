...
import { ACCOUNT_ID, FROM_DATE_TIME, LIST_TICKER_INCLUDE_DEACTIVE, SOCKET_CONNECTED, SUB_ACCOUNTS, TO_DATE_TIME } from '../../../constants/general.constant';
...
const MultiTraderTable = () => {
    ...
    const [listTicker, setListTicker] = useState<ISymbolInfo[]>(JSON.parse(localStorage.getItem(LIST_TICKER_INCLUDE_DEACTIVE) || "[]"));
