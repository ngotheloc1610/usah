...
function SearchTradeHistory(props: IPropsSearchTradeHistory) {
    ...
    const sendMessageTradeSearch = () => {
        ...
        const toDateToday = convertDatetoTimeStamp(moment().format(FORMAT_DATE), TO_DATE_TIME)
        ...
        if (wsConnected) {
            ...
            convertNumber(toDatetime.toString()) !== 0 ? tradeHistoryRequest.setToDatetime(toDatetime) : tradeHistoryRequest.setToDatetime(toDateToday);
